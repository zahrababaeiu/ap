...
public class MenuHandler {
    ...
    private void librarianMenueHandel() {
        ...
        while (true) {
            ...
            System.out.println("8. show Loan Statistics");
            ...
            switch (choice) {
                ...
                case 6:
                    System.out.println("Enter student username: ");
                    String stuusername2 = scanner.nextLine();
                    librarySystem.active(stuusername2);
                    break;
                ...
                case 8:
                    librarySystem.showLoanStatistics();
                    break;
        ...
        while (currentUser != null) {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    if (librarySystem.chekingState(currentUser.getUsername())) {
